	...
	*/
	...
	?>
       <header class="header">
            <div class="container">
            	<div class="row">
                <nav class="navbar navbar-inverse navbar-toggleable-md col-md-8 col-sm-11">
                ...
                <div class="col-md-4 col-sm-1 pull-right" id="nav_icon_right">
                    <form role="search" method="get" class="search-form" action="https://readyfireaimtalks.com/">
                        <label>
    ...
    <div class="container">
        ...
        <div class="col-md-6">
           ...
           <div class="col-md-6" style="text-align:right">
                ...
                <a href="<?php /* translators:straing */ echo esc_url(  'https://theagora.com/' ); ?>"><?php /* translators:straing */  printf( esc_html__( 'The Agora', 'newsbd24' )); ?></a>
             
        <?php
        //printf(  /* translators: %s: aThemeArt */  '<a href="' . esc_url('https://14west.us/' ) . '" target="_blank">' . esc_html__( '14 West', 'newsbd24' ) . '</a>' ); 
               ?>
