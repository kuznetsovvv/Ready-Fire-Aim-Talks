...
class Wistia_Thumbnails extends Video_Thumbnails_Provider {
	...
	public $regexes = array(
        ...
        '#(wistia_async_[a-z0-9]*[a-z0-9])#' //oembed
	);
	...
	public function get_thumbnail_url( $id ) {
		...
		// ID is a class on an oembed div, convert it to a URL
		if ( substr( $id, 0, 12 ) != 'wistia_async_' ) $id = 'http://fast.wistia.net/embed/iframe/' . substr($id, strrpos($id, "_") +1 );
